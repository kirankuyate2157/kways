...
import { sendMail } from "@/utils/contactMail";
          ...
          <section id='Solution' className='flex px-2 lg:flex-col'>
            ...
            >
              ...
              <form
                ...
                className='z-10 grid grid-cols-1 text-black md:grid-cols-2  gap-4'
              >
                ...
                <div className='col-span-2 mb-4 dark:text-white'>
                  <label
                    for='subject'
                    className='block text-sm font-medium text-gray-700 dark:text-gray-300'
                  >
                ...
                <button
                  type='submit'
                  className='px-4 py-2 bg-pink-00 border bg-pink-400 text-white rounded-md hover:bg-pink-600'
                >
                  Send Message
                </button>
              </form>
